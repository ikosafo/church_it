<style>
    ...
    toolbar.navbar-mobile.navbar-tablet {
        background-color: #970908 !important;
    }
    ...
    <ul class="navbar-nav nav-center site-logo">
        <li>
            <a href="index.php">
                ...
                <span class="brand-text">SEBSON</span>
            </a>
        </li>
    </ul>
...
<nav class="top-toolbar navbar navbar-mobile flex-nowrap">
    ...
    <ul class="navbar-nav nav-left">
        ...
        <li class="nav-item nav-text dropdown dropdown-menu-xl">
            <a href="javascript:void(0)" data-toggle="dropdown"
               role="button" aria-haspopup="true" aria-expanded="false" style="color:#FFFFFF !important;">
							<span>
								Menus
							</span>
                <i class="icon dripicons-chevron-down menu-arrow-down" style="color:#ffffff"></i>
            </a>
            <div class="dropdown-menu dropdown-icon-menu dropdown-menu-left">
                <div class="dropdown-header">
                    Quick Links
                </div>
                <a href="account_table.php" class="dropdown-item <?php echo(
                $_SERVER['PHP_SELF'] == "/account_table.php"
                    ? "active" : ""); ?>">
                    <i class="icon dripicons-power"></i> Applicant Accounts
                </a>
                <a href="messages.php" class="dropdown-item <?php echo(
                $_SERVER['PHP_SELF'] == "/messages.php"
                    ? "active" : ""); ?>">
                    <i class="icon dripicons-mail"></i> Messages
                </a>
                <!--<a href="export.php" class="dropdown-item <?php /*echo(
                $_SERVER['PHP_SELF'] == "/export.php"
                    ? "active" : ""); */?>">
                    <i class="icon dripicons-cloud-download"></i> Export to Excel
                </a>-->
                <a href="report.php" class="dropdown-item <?php echo(
                $_SERVER['PHP_SELF'] == "/report.php"
                    ? "active" : ""); ?>">
                    <i class="icon dripicons-graph-pie"></i> Report and Statistics
                </a>
                <a href="logs.php" class="dropdown-item <?php echo(
                $_SERVER['PHP_SELF'] == "/logs.php"
                    ? "active" : ""); ?>">
                    <i class="icon dripicons-loading"></i> Logs
                </a>
            </div>
        </li>
        <!-- END MEGA MENU -->
    ...
    <span style="color: #ffffff;text-align: center !important;">
        AHPC ADMIN MANAGEMENT <br/>SYSTEM FOR MIS
    </span>
